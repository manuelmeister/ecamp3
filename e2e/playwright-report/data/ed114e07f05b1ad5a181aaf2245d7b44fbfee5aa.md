...
- Name: nuxtPrint.spec.js >> Nuxt print test >> downloads PDF >> for whole camp
- Location: specs/nuxtPrint.spec.js:56:9
...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/camps
Call log:
  - navigating to "http://localhost:3000/camps", waiting until "load"
